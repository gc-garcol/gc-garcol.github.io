    ...
    <Container className="container">
      ...
      <BaseContent className="base-content">
        ...
        <ContentContainer>
          ...
          <Feature style={{ marginTop: 16 }} className="blue" target="_blank" href="https://dzone.com/articles/how-to-reach-500k-opssec-with-only-3-redis-nodes-i">Reaching 500K Ops/Sec With Only 3 Redis Nodes</Feature>
